...
public class Main {
    ...
    public static void validaceOsoby(String jmeno, String prijmeni, String rodneCislo) {
        ...
        // Toto kontrolovat není v tomto případě potřeba, protože jméno ani přijmeni není možné zadat tak, aby to bylo prázdné,
        // při braní vstupu uživatele jsme totiž použili scanner.next() místo scanner.nextLine()
